...
Monorepo de TPs de IA generativa. Cada subcarpeta es un TP independiente con sus propias
reglas: antes de tocar algo, leé el `CLAUDE.md` / `README.md` de esa carpeta.
